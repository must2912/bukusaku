...
public class SharedPrefManager {
    ...
    private static final String KEY_POIN = "keypoin";
    private static final String KEY_KETERANGAN = "keyketerangan";
    ...
    public void userLogin(User user) {
        ...
        editor.putInt(KEY_POIN, user.getPoin());
        editor.putString(KEY_KETERANGAN, user.getKeterangan());
        editor.apply();
    }
    ...
    public User getUser() {
        ...
        return new User(
                ...
                sharedPreferences.getInt(KEY_POIN, 0)
        );
    }
